...
namespace DS3Planner
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<ArmorPieceRepository>();
            services.AddScoped<ArmorPieceService>();

            services.AddScoped<RingRepository>();
            services.AddScoped<RingService>();

            services.AddScoped<WeaponRepository>();
            services.AddScoped<WeaponService>();

            services.AddScoped<FullBuildRepository>();
            services.AddScoped<FullBuildService>();
